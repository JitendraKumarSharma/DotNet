...
namespace CustomizedTokenBasedAuthentication_WebAPI.GlobalData
{
    public static class EncryptDecrypt
    {
        public static string Encrypt(string encryptString)
        {
            string EncryptionKey = "abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ1234567890~!@#$%^&*()";  //we can change the code converstion key as per our requirement, but the decryption key should be same as encryption key    
